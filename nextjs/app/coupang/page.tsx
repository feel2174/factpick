...
export const metadata: Metadata = {
  title: '쿠팡 상품 검색 결과',
  description: '선택한 성분과 관련된 쿠팡 상품을 확인합니다.',
    ...
    <main id="main-content" className="content-shell py-8 sm:py-12">
      ...
      {products.length > 0 ? (
              ...
              >
                ...
                <div className="border-t border-slate-100 p-5">
                  <div className="flex flex-wrap gap-2 text-xs font-bold">
                    {product.isRocket && <span className="rounded-md bg-sky-50 px-2.5 py-1 text-sky-700">로켓배송</span>}
                    {product.isFreeShipping && <span className="rounded-md bg-emerald-50 px-2.5 py-1 text-emerald-700">무료배송</span>}
                  </div>
                  ...
                  <span className="mt-4 inline-flex min-h-11 w-full items-center justify-center rounded-lg bg-amber-400 px-4 text-sm font-bold text-amber-950 transition group-hover:bg-amber-500">
        ...
        <section className="surface-card mt-8 max-w-3xl p-6 sm:p-8">
          <h2 className="text-xl font-bold text-slate-950">표시할 상품이 없습니다</h2>
